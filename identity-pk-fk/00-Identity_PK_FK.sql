...
-- MAGIC To run this demo, just select the cluster `dbdemos-identity-pk-fk-lmtquan` from the dropdown menu ([open cluster configuration](https://adb-8568678278820800.0.azuredatabricks.net/#setting/clusters/0119-091341-5uehhcki/configuration)). <br />
...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=DBSQL&org_id=8568678278820800&notebook=%2F00-Identity_PK_FK&demo_name=identity-pk-fk&event=VIEW&path=%2F_dbdemos%2FDBSQL%2Fidentity-pk-fk%2F00-Identity_PK_FK&version=1">
